                    ...
                    s instanceof o
                      ...
                      : function (e, i) {
                          ...
                          c(i.props, function (t, e) {
                            ...
                            l[n] &&
                              t.inArray(null, l[n].slice(0, 3)) < 0 &&
                              ((l[n][3] = 1),
      ...
      t.each(
        ...
        t.fn.extend({
          addClass:
            ...
            function (e, i, n, o) {
              return i
                ? t.effects.animateClass.call(this, { add: e }, i, n, o)
      ...
      t.expr &&
        ...
        (t.fx.step.clip = function (e) {
          e.clipInit ||
            ...
            'string' == typeof e.end && (e.end = c(e.end, e.elem)),
            (e.clipInit = !0)),
            t(e.elem).cssClip({
        ...
        t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function () {
          if (!this.options.disabled && !this.greedyChild && this.visible) {
            var s,
              n,
              o,
              a = y(e, this, this.options.tolerance, i),
              r =
                !a && this.isover
                  ? 'isout'
                  : a && !this.isover
...
$(document).ready(function (s) {
  ...
  function p(e) {
    ...
    if (e.parents('.tm-headline').hasClass('type')) {
      ...
      !(function e(i, n, t, d) {
        ...
        f(i.find('i').eq(0), i, w, d);
    } else
      e.parents('.tm-headline').hasClass('clip')
        ? e
            .parents('.tm-words-wrapper')
            .animate({ width: '2px' }, c, function () {
              m(e, i), u(i);
            })
        : e.parents('.tm-headline').hasClass('loading-bar')
        ? (e.parents('.tm-words-wrapper').removeClass('is-loading'),
          m(e, i),
          setTimeout(function () {
            p(i);
          }, n),
  ...
  function u(s, e) {
    s.parents('.tm-headline').hasClass('type')
      ? (f(s.find('i').eq(0), s, !1, e),
        s.addClass('is-visible').removeClass('is-hidden'))
      : s.parents('.tm-headline').hasClass('clip') &&
        s
          .parents('.tm-words-wrapper')
  ...
  function f(s, e, i, n) {
    s.addClass('in').removeClass('out'),
      s.is(':last-child')
        ? (e.parents('.tm-headline').hasClass('type') &&
            setTimeout(function () {
  ...
  s('.tm-headline.letters')
    ...
    .each(function () {
      ...
      for (e in a)
        i.parents('.rotate-2').length > 0 && (a[e] = '<em>' + a[e] + '</em>'),
          (a[e] = n ? '<i class="in">' + a[e] + '</i>' : '<i>' + a[e] + '</i>');
      var t = a.join('');
...
(function (e) {
  ...
  function n(e, n, o, i, a) {
    ...
    n = n.split(O);
    for (var c, r, d = t(e), m = n.length; m--; )
      (r = n[m]),
        (c = d[r] || (d[r] = [])),
        c.push([o, u]),
  ...
  function K(e) {
    o(document, z.move, e.activeTouchmove),
      o(document, z.end, e.activeTouchend);
  }
  function j(e, t, n) {
    var o = n - e.timeStamp;
  ...
  function Q(e) {
    ...
    if (!e.defaultPrevented && e.moveEnabled) {
      ...
      void 0 === e.identifier
        ? (n(e.target, 'click', c),
          n(document, N.move, b, u),
          n(document, N.end, T, u))
        : ((u.activeTouchmove = function (e, t) {
            S(e, t);
          }),
          (u.activeTouchend = function (e, t) {
            k(e, t);
          }),
          n(document, z.move, u.activeTouchmove, u),
          n(document, z.end, u.activeTouchend, u));
    }
  }
  function q(e) {
    e.enableMove();
  ...
  var D = { textarea: !0, input: !0, select: !0, button: !0 },
