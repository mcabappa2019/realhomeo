          ...
          <div className="tm-tab-content">
            ...
            <div className="tm-tabs-item">
              <div className="row">
                <div className="col-lg-6">
                  <div className="tm-dept-img">
                    <img src="/assets/img/2.neurology.webp" alt="" />
                  </div>
                </div>
                {/* <!-- .col --> */}
                <div className="col-lg-6">
            ...
            <div className="tm-tabs-item">
              <div className="row">
                <div className="col-lg-6">
                  <div className="tm-dept-img">
                    <img src="/assets/img/3.crutches.webp" alt="" />
                  </div>
                </div>
                {/* <!-- .col --> */}
                <div className="col-lg-6">
            ...
            <div className="tm-tabs-item">
              <div className="row">
                <div className="col-lg-6">
                  <div className="tm-dept-img">
                    <img src="/assets/img/4.cardiology.webp" alt="" />
                  </div>
                </div>
                {/* <!-- .col --> */}
                <div className="col-lg-6">
            ...
            <div className="tm-tabs-item">
              <div className="row">
                <div className="col-lg-6">
                  <div className="tm-dept-img">
                    <img src="/assets/img/5.pulmones.webp" alt="" />
                  </div>
                </div>
                {/* <!-- .col --> */}
                <div className="col-lg-6">
            ...
            <div className="tm-tabs-item">
              <div className="row">
                <div className="col-lg-6">
                  <div className="tm-dept-img">
                    <img src="assets/img/6.xray.webp" alt="" />
                  </div>
                </div>
                {/* <!-- .col --> */}
                <div className="col-lg-6">
